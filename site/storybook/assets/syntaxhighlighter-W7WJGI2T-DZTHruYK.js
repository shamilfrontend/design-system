import { i as e, s as t } from './preload-helper-CMdWXl7s.js';
import {
  Jr as n,
  Yr as r,
  di as i,
...
import { t as s } from './react-CiPtek2X.js';
import { C as c, a as l, l as u, w as d } from './theming-B7CHcLtQ.js';
import { n as f, t as p } from './chunk-242VQQM5-DMbhhNLy.js';
import {
  a as m,
  i as h,
  n as g,
    ...
    if (!a) p = T(T({}, s), {}, { className: k(s.className) });
      ...
      p = T(
        ...
        {},
        {
          ...
          style: O(s.className, Object.assign({}, s.style, i), n)
        }
      );
    }
    var _ = f(t.children);
...
function ue(e) {
  ...
  if (
    ((p.className = p.className
      ? [].concat(re(p.className.trim().split(/\s+/)), re(l))
      : l),
    n && a)
  ) {
    var m = L(r, n, i);
...
function R(e) {
  for (
    ...
    var i = e[r];
    if (i.type === `text`)
      n.push(ue({ children: [i], className: re(new Set(t)) }));
    else if (i.children) {
          ...
          if (i === 0) {
            var c = g(
              u
                .slice(f + 1, p)
                .concat(
                  ue({ children: [s], className: e.properties.className })
                ),
              o
            );
            d.push(c);
  ...
  return function (n) {
      ...
      u =
        l === void 0
          ? {
              ...
              style: I(
                I({}, o[`code[class*="language-"]`]),
                o[`code[class*="language-${r}"]`]
              )
            }
          : l,
      d = n.useInlineStyles,
    ...
    return W.createElement(
      ...
      W.createElement(
        ...
        u,
        !g && F,
        E({ rows: le, stylesheet: o, useInlineStyles: f })
      )
    );
  };
}
function V({
  ...
  return {
    children: s ? t : e,
    buttonProps: (0, G.useMemo)(
      () => ({ onClick: u, ariaLabel: s ? a : i }),
      [u, s, a, i]
    )
  };
}
  ...
  (_(),
                ...
                if (s.type === `keyword` && s.content === `mutation`) {
                  ...
                  if (
                    ...
                    for (; n < l; n++) {
                      var u = r(0);
                      u.type === `variable` &&
                        (o(u, `variable-input`), c.push(u.content));
                    }
                    n = l + 1;
                  }
                  if (
    ...
    (Ie = i({
      '../../node_modules/hastscript/node_modules/comma-separated-tokens/index.js'(
        ...
        function i(e) {
          for (
            var n = [], i = String(e || r), a = i.indexOf(t), o = 0, s = !1, c;
            !s;
          )
            (a === -1 && ((a = i.length), (s = !0)),
              (c = i.slice(o, a).trim()),
      ...
      '../../node_modules/refractor/node_modules/parse-entities/decode-entity.browser.js'(
        ...
        function i(e) {
          ...
          return (
            ...
            (n.innerHTML = t),
            (i = n.textContent),
            (i.charCodeAt(i.length - 1) === r && e !== `semi`) || i === t
              ? !1
              : i
          );
        }
      ...
      '../../node_modules/refractor/node_modules/parse-entities/index.js'(
        ...
        function ne(e, t) {
          var i = t.additional,
            ...
            Q;
          for (
            typeof i == `string` && (i = i.charCodeAt(0)),
              X = $(),
              K = ne ? ye : u,
              L--,
              le++;
            ...
            if (
              (U === p && (R = ce[ue] || 1), (U = e.charCodeAt(L)), U === g)
            ) {
              if (
                ((G = e.charCodeAt(L + 1)),
                G === f ||
              ...
              ((V = e.charCodeAt(Q) === _),
                ...
                W
                  ? (be(),
                    ...
                    ve.offset++,
                    F &&
                      F.call(ae, W, { start: X, end: ve }, e.slice(J - 1, Q)),
                    (X = ve))
                  : ((H = e.slice(J - 1, Q)),
                    (z += H),
                    (R += H.length),
                  ...
                  for (
                    ...
                    if (!(S instanceof a)) {
                      var C = 1,
                        w;
                      if (v) {
                        if (((w = o(te, x, e, _)), !w || w.index >= e.length))
                          break;
                        var T = w.index,
                          E = w.index + w[0].length,
                          D = x;
                        for (D += b.value.length; T >= D; )
                          ((b = b.next), (D += b.value.length));
                        if (
                          ((D -= b.value.length), (x = D), b.value instanceof a)
                        )
                          continue;
                        for (
                          var O = b;
      ...
      '../../node_modules/refractor/core.js'(e, t) {
        ...
        function y(e, t) {
          ...
          for (i = -1, r = n.length; ++i < r; )
            ((a = n[i]), (n[i] = p.Token.stringify(a, t, n)));
          return n;
        }
        function te(e) {
          return e;
    ...
    (bt = ({ children: e, className: t }) =>
      H.createElement(
        m,
        { horizontal: !0, vertical: !0, focusable: !0, className: t },
        e
      )),
    (xt = u(bt)(
    ...
    (Et = (e, t) =>
      t
        ? e
          ? ({ rows: t, ...n }) => e({ rows: t.map(e => wt(e)), ...n })
          : Tt
        : e),
    (Dt = ({
      children: e,
      ...
      let { children: f, buttonProps: p } = V({ content: u }),
        m = Et(l.renderer, c);
      return H.createElement(
        ...
        n
          ? H.createElement(h, {
              actionItems: [{ title: f, onClick: p.onClick }],
              flexLayout: !0
            })
          : null
      );
