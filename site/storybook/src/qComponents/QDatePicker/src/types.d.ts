...
import { default as DatePanel } from './panel/Date/DatePanel.vue';
import { DatePanelInstance } from './panel/Date/types';
import { default as DateRangePanel } from './panel/DateRange/DateRange.vue';
import { default as MonthRangePanel } from './panel/MonthRange/MonthRange.vue';
import { default as YearRangePanel } from './panel/YearRange/YearRange.vue';
interface Shortcut {
  text: string;
  value: Date;
}
