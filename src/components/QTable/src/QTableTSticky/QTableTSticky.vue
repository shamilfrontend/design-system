...
import type { QScrollbarProvider } from '@/components/QScrollbar';
...
import type { StickyGlobalConfig } from './types';
...
watch([qScrollbar.moveXInPx, qScrollbar.sizeWidth, offsetsList], ([value]) => {
...
<template>
  <tr ref="root">
    ...
    />
    <th
      v-for="(column, index) in qTableContainer.columnList"
      :key="index"
